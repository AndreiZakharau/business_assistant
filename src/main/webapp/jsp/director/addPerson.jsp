...
<div class="container ">
    <div class="card">
        <div class="card-body">
            <h1><fmt:message key="translation.director.addPerson"/></h1>
        ...
        <ul>
        <a  type="submit" class="active" href="/jsp/director/directors_work_page.jsp"><fmt:message key="translation.button.exit"/>
        </a>
        </ul>
    </div>
</div>
